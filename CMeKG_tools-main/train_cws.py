...
from model.model_cws.bert_lstm_crf import *
import os
...
vocab = load_vocab('model/medical_cws/vocab.txt')
####读取训练集
...
model = BERT_LSTM_CRF('model/medical_cws', tagset_size, 768, 200, 2,
...
for epoch in range(epochs):
    ...
    if f > best_f:
        ...
        model_name = 'model/medical_cws' + 'devf1-' + str(float('%.3f' % best_f)) + "-testf1-"+str(float('%.3f' %test_f1)) +".pkl"
