...
class medical_seg(object):
    def __init__(self):
        self.NEWPATH = 'model/medical_cws/pytorch_model.pkl'
        ...
        self.vocab = load_vocab('model/medical_cws/vocab.txt')
        self.vocab_reverse = {v: k for k, v in self.vocab.items()}

        self.model = BERT_LSTM_CRF('model/medical_cws', tagset_size, 768, 200, 2,
